            ...
            <footer className="p-4 bg-gray-50 text-center text-xs text-gray-500 border-t border-gray-200">
                <div className="space-y-2">
                    ...
                    <div className="flex justify-center items-center space-x-4 text-xs">
                        <a href="/privacy.html" className="text-blue-600 hover:text-blue-800 underline">プライバシーポリシー</a>
                        <a href="/terms.html" className="text-blue-600 hover:text-blue-800 underline">利用規約</a>
