  ...
  const getToolHint = (tool: Tool): string => {
    const hints = {
      ja: {
        ...
        [LineType.Solid]: '2つの要素をクリックして実線で結ぶ',
        [LineType.Dashed]: '2つの要素をクリックして破線で結ぶ',
      ...
      en: {
        ...
        [LineType.Solid]: 'Click two elements to connect with solid line',
        [LineType.Dashed]: 'Click two elements to connect with dashed line',
